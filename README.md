# AI's sycophantic tone impacts perceived but not actual competence.

Data and code from manuscript: Duettmann, A. & Sharot, T. (in prep.). AI's sycophantic tone impacts perceived but not actual competenc
